...
This folder holds learning materials and Jupyter notebooks for exercises related to the module:

- Microsoft Learn module: https://learn.microsoft.com/en-us/training/modules/explore-analyze-data-with-python/
...
- Run the notebooks with `jupyter lab` or `jupyter notebook` from the project root after activating `.venv`.
